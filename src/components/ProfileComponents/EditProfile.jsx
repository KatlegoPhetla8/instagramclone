...
import { useShowToast } from '../../hooks/useShowToast';
  ...
  export function EditProfile ({isOpen, onClose}){
    ...
    const authUser = useAuthStore((state) => state.user); // custom hook from store/useAuthStore
    const fileRef = useRef(null); // Ref that is used in the input for the edit picture button.
    const {selectedFile, handleImageChange, setSelectedFile} = usePreviewImg(); // custom hook from hooks/usePreviewImg
